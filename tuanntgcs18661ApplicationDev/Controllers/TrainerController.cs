...
namespace tuanntgcs18661ApplicationDev.Controllers
{
    ...
    public class TrainerController : Controller
    {
        ...
        public async Task<IActionResult> Index()        
        {
            ...
            var classroomIds = await _context.Topics.Where(t => t.TrainerId == userId).Select(t => t.ClassroomId).ToListAsync();
            var classrooms = await _context.Classrooms.Where(c => classroomIds.Contains(c.Id)).Include(c => c.ClassProfile).Include(c => c.Course.Category).ToListAsync();
