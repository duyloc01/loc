...
namespace tuanntgcs18661ApplicationDev.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Code,Description,Name_EN,Name_VI,Credit,Hour,CategoryId")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Code,Description,Name_EN,Name_VI,Credit,Hour,CategoryId")] Course course)
        {
            if (id != course.Id)
            {
                return NotFound();
